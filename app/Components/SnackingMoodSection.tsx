  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6">
      ...
      <motion.div
        ...
        className="relative z-[110] w-full max-w-2xl bg-white rounded-2xl shadow-2xl max-h-[92vh] overflow-y-auto"
      >
        ...
        >
          <div className="flex justify-between items-start border-b-2 border-gray-900 pb-5">
            <div>
              <p className="text-2xl font-black text-[#8B3A1A] uppercase">
                {STORE_NAME}
              </p>
            ...
            <div className="text-right">
              ...
              <span className="inline-block mt-1 bg-green-100 text-green-700 text-[10px] font-black px-2 py-0.5 rounded-full">
                ✓ ORDER PLACED
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-xs leading-relaxed">
          ...
          <div className="flex justify-end">
            <div className="w-full sm:w-72 border border-gray-200 rounded-xl overflow-hidden text-xs">
              ...
              {comboSummary.totalSavings >
                0 && (
                <div className="flex justify-between px-4 py-2 border-b border-gray-100 text-green-600">
                  <span>You Saved</span>
...
export default function ProductsPage() {
  ...
  const toggleComboProduct = (
    product: Product
  ) => {
    // Coming Soon product cannot be added
                ...
                return (
                  ...
                  >
                    ...
                    {product.isComingSoon ? (
                      <div className="relative block aspect-square w-full overflow-hidden bg-[#F5EAD8] cursor-not-allowed">
                        ...
                        <div className="absolute top-3 left-3 z-20">
                          <span className="inline-flex items-center gap-1.5 bg-black/80 text-white text-[9px] sm:text-[10px] font-black uppercase tracking-wider px-2.5 py-1.5 rounded-full shadow-lg backdrop-blur-sm">
                        ...
                        <div className="absolute inset-0 z-20 flex items-center justify-center">
                          <span className="bg-white/90 text-[#8B3A1A] px-4 py-2 rounded-full text-[11px] sm:text-xs font-black uppercase tracking-widest shadow-xl">
                            Coming Soon
                          </span>
                        </div>
                    ...
                    <div className="flex flex-col flex-1 px-2.5 pt-2 pb-2.5 gap-1.5">
                      ...
                      {product.isComingSoon ? (
                        <div>
                          ...
                          <p className="text-[9px] text-[#B74418] font-black uppercase tracking-wider mt-1">
                            Available Soon
                          </p>
                        </div>
                      ) : (
                      ...
                      {product.isComingSoon ? (
                        <button
                          type="button"
                          disabled
                          className="mt-auto flex w-full items-center justify-center gap-1.5 rounded-xl bg-gray-400 py-2.5 text-[12px] font-black uppercase tracking-wider text-white shadow-sm cursor-not-allowed opacity-80"
                        >
                          Coming Soon
                        </button>
                      ) : (
        ...
        {isCartDrawerOpen && (
          <div className="fixed inset-0 z-[80] flex justify-end">
            ...
            <motion.div
              ...
              className="relative z-[90] w-full max-w-md bg-white h-full shadow-2xl flex flex-col"
            >
        ...
        {activeReviewProduct && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative z-[110] w-full max-w-lg bg-white rounded-3xl p-6 shadow-2xl max-h-[85vh] flex flex-col"
            >
