...
import JoinFamSection from './Components/JoinFamSection';
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex items-center justify-center mb-8">
        ...
        <a
          ...
          className="relative flex h-14 w-14  items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-transform duration-300 hover:scale-110 hover:bg-[#128C7E] focus:outline-none focus:ring-4 focus:ring-green-300"
        >
